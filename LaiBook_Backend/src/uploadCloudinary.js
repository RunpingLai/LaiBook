...
if (!process.env.CLOUDINARY_URL) {
    // process.env.CLOUDINARY_URL="cloudinary://333137616744361:iJQGt11U4jRPKAXuGrEmR-zlgoA@hb5atmbev"
    process.env.CLOUDINARY_API_KEY="848133239873764"
    process.env.CLOUDINARY_URL="cloudinary://848133239873764:6JfHeyil1UetROf_FG66ZWSoFUs@hdiqixb6i"
    // console.error('*******************************************************************************')
    // console.error('*******************************************************************************\n')
...
module.exports = { uploadImage, setup, parseFD }
